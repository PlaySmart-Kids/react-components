import{a,j as r,T as i,m as o}from"./Divider-DdokZ4G_.js";import{r as t}from"./index-BwDkhjyp.js";import{D as f}from"./DefaultThemeProvider-DWbcdqGt.js";import{I as h}from"./Input-D5bJgjba.js";import"./_commonjsHelpers-BosuxZz1.js";import"./InputUtil-DkXrE-40.js";function g(e){const[c,n]=t.useState();t.useState("10000"),t.useState("2024-01-01"),t.useEffect(()=>{n(e.value)},[e.value]);const m=p=>{n(p.currentTarget.value)};return r("div",{style:{padding:"24px"},children:[r(i,{component:"h4",className:"title-space",children:["Input demo",a(i,{component:"span",variant:"heading6",children:" (using controls to change properties of this widget)"})]}),a("div",{className:"demo-panel",style:{display:"flex",paddingBlockStart:o(30),marginInline:"auto",marginBlockStart:"0",flexDirection:"column",gap:o(20),justifyContent:"start",alignItems:"start",width:e.fullWidth?"100%":o(200)},children:a(h,{...e,value:c,onChange:m})})]})}const k={component:g,decorators:[e=>a(f,{children:a(e,{})})],argTypes:{color:{options:["primary","info","success","warning","error","secondary"],control:{type:"radio"}},title:{defaultValue:"Title"},placeholder:{defaultValue:""},hue:{defaultValue:"main",options:["light","main","dark","darker"],control:{type:"radio"}},type:{defaultValue:"text",options:["text","password","email","number"],control:{type:"radio"}},size:{defaultValue:"normal",options:["large","normal","small"],control:{type:"radio"}},fullWidth:{defaultValue:!1,control:{type:"boolean"}},disabled:{defaultValue:!1,control:{type:"boolean"}},hint:{defaultValue:"",control:{type:"text"}},alwaysHighlight:{defaultValue:!1,control:{type:"boolean"}},shrinkTitle:{defaultValue:!0,control:{type:"boolean"}},compact:{defaultValue:!1,control:{type:"boolean"}}}},l={args:{color:"primary",size:"normal",hue:"main",type:"text",title:"Title",fullWidth:!1,disabled:!1,multiLines:!1,hint:void 0,value:"hello",shrinkTitle:!0,alwaysHighlight:!1,compact:!1,placeholder:""}};var s,u,d;l.parameters={...l.parameters,docs:{...(s=l.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    color: 'primary',
    size: 'normal',
    hue: 'main',
