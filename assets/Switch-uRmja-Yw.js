import{j as e}from"./jsx-runtime-CkxqCPlQ.js";import{useMDXComponents as r}from"./index-BrnU7xv7.js";import{ae as n,af as i}from"./index-DS4mN-Cx.js";import{S as l}from"./Switch-BSBrATWg.js";import d from"./Switch.stories-BXp2enSV.js";import"./index-DJO9vBfz.js";import"./iframe-ByIxP18h.js";import"../sb-preview/runtime.js";import"./index-Cp9I2zMD.js";import"./index-CvTBScqg.js";import"./index-DrFu-skq.js";import"./DefaultThemeProvider-DB5yquFP.js";import"./index-CikfRwdJ.js";import"./CheckboxUtil-CqPWmFQ9.js";function o(s){const t={code:"code",h1:"h1",h3:"h3",p:"p",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n,{of:d,title:"clients/ui/checkbox/Switch"}),`
...
event.`]}),e.jsxs("div",{className:"flex-horizontal sb-unstyled",children:[e.jsx(l,{title:"Option A",defaultChecked:!0,onChange:c=>{console.log("Switch A >>> "+c.currentTarget.checked)}}),e.jsx(l,{title:"Option B",onChange:c=>{console.log("Switch B >>> "+c.currentTarget.checked)}})]}),e.jsx(i,{code:`
...
<Switch labelAnchor="east"
        title={'Right'} />
`,language:"tsx",dark:!0})]}),`
`,e.jsxs("div",{className:"preview-panel",children:[e.jsx(t.h3,{id:"appearance",children:"Appearance"}),e.jsxs(t.p,{children:["Use the ",e.jsx(t.code,{children:"alwaysHighlight"})," prop to ensure the ",e.jsx(t.code,{children:"Switch"})," always displays color (",e.jsx(t.code,{children:"true"}),`),
regardless of whether it is on or off. By default, the switch does not always
show the color (`,e.jsx(t.code,{children:"false"}),")."]}),e.jsxs("div",{className:"flex-horizontal sb-unstyled",children:[e.jsx(l,{title:"Normal"}),e.jsx(l,{alwaysHighlight:!0,title:"Always Highlight"})]}),e.jsx(i,{code:`
<Switch title={'Normal'} />
...
<Switch title={'Option B'}
        defaultChecked={true} />
`,language:"tsx",dark:!0})]})]})}function y(s={}){const{wrapper:t}={...r(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(o,{...s})}):o(s)}export{y as default};
