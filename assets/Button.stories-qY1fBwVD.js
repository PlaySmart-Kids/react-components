import{b as r,M as y,d as i}from"./index-D8Bq1aUh.js";import{B as o}from"./Button-Bqv8ahTI.js";import{j as t,a as e,d as l,M as d,F as S}from"./DefaultThemeProvider-DbvuuPiG.js";import"./index-BwDkhjyp.js";import{useMDXComponents as h}from"./index-BnapxFVb.js";import"./iframe-CIX_G1sr.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-B8XB3FuZ.js";import"./index-Cmc67Rxs.js";import"./index-DrFu-skq.js";import"./ColorUtil-Cr_cz2D9.js";import"./useTimeout-CJ17nKGE.js";import"./index-DOJJSfO9.js";import"./useRipple-CLSESEbx.js";function u(a){const n=Object.assign({h1:"h1",p:"p",code:"code",h4:"h4"},h(),a.components);return t(S,{children:[e(y,{title:"clients/ui/button/Button"}),`
...
<Button variant="outlined">Outlined</Button>
<Button variant="text">Text</Button>
\`} language={"tsx"} dark={true} /></div>`}};const B=()=>t("div",{className:"preview-panel",children:[t("h4",{id:"color",children:["Color",e("br",{}),e("br",{})]}),t("p",{children:["You can use the ",e("code",{children:"color"})," prop to apply different color variants, representing various button types. ",e("code",{children:"Primary"})," is the default color.",e("br",{}),e("br",{})]}),t("div",{className:"flex-horizontal",children:[e(o,{color:"primary",children:"Primary"}),e(o,{color:"secondary",children:"Secondary"}),e(o,{color:"info",children:"Info"}),e(o,{color:"error",children:"Error"}),e(o,{color:"warning",children:"Warning"}),e(o,{color:"success",children:"Success"})]}),e(r,{code:`
<Button color="primary">Primary</Button>
<Button color="secondary">Secondary</Button>
<Button color="info">Info</Button>
<Button color="error">Error</Button>
<Button color="warning">Warning</Button>
<Button color="success">Success</Button>
`,language:"tsx",dark:!0})]});B.storyName="Color";B.parameters={storySource:{source:`<div className={"preview-panel"}><h4 id="color">{"Color"}<br /><br /></h4><p>{"You can use the "}<code>{"color"}</code>{" prop to apply different color variants, representing various button types. "}<code>{"Primary"}</code>{" is the default color."}<br /><br /></p><div className={"flex-horizontal"}><Button color="primary">{"Primary"}</Button><Button color="secondary">{"Secondary"}</Button><Button color="info">{"Info"}</Button><Button color="error">{"Error"}</Button><Button color="warning">{"Warning"}</Button><Button color="success">{"Success"}</Button></div><Source code={\`
<Button color="primary">Primary</Button>
<Button color="secondary">Secondary</Button>
<Button color="info">Info</Button>
<Button color="error">Error</Button>
<Button color="warning">Warning</Button>
<Button color="success">Success</Button>
\`} language={"tsx"} dark={true} /></div>`}};const p=()=>t("div",{className:"preview-panel",children:[t("h4",{id:"hue",children:["Hue",e("br",{}),e("br",{})]}),t("p",{children:["You can customize the color tone of the ",e("code",{children:"Button"})," component by using the ",e("code",{children:"hue"})," prop, allowing you to select specific shades or tones that align with your design requirements.",e("br",{}),e("br",{})]}),t("div",{className:"flex-horizontal",children:[e(o,{hue:"lightest",children:"Lightest"}),e(o,{hue:"lighter",children:"Lighter"}),e(o,{hue:"light",children:"Light"}),e(o,{children:"Normal"}),e(o,{hue:"dark",children:"Dark"}),e(o,{hue:"darker",children:"Darker"}),e(o,{hue:"darkest",children:"Darkest"})]}),e(r,{code:`
<Button hue="lightest">Lightest</Button>
<Button hue="lighter">Lighter</Button>
<Button hue="light">Light</Button>
<Button>Normal</Button>
...
<Button hue="darker">Darker</Button>
<Button hue="darkest">Darkest</Button>
`,language:"tsx",dark:!0})]});p.storyName="Hue";p.parameters={storySource:{source:`<div className={"preview-panel"}><h4 id="hue">{"Hue"}<br /><br /></h4><p>{"You can customize the color tone of the "}<code>{"Button"}</code>{" component by using the "}<code>{"hue"}</code>{" prop, allowing you to select specific shades or tones that align with your design requirements."}<br /><br /></p><div className={"flex-horizontal"}><Button hue="lightest">{"Lightest"}</Button><Button hue="lighter">{"Lighter"}</Button><Button hue="light">{"Light"}</Button><Button>{"Normal"}</Button><Button hue="dark">{"Dark"}</Button><Button hue="darker">{"Darker"}</Button><Button hue="darkest">{"Darkest"}</Button></div><Source code={\`
<Button hue="lightest">Lightest</Button>
<Button hue="lighter">Lighter</Button>
<Button hue="light">Light</Button>
<Button>Normal</Button>
...
<Button>Button with Ripple Effect</Button>
<Button noRippleEffect={true}>Button with no Ripple Effect</Button>
\`} language={"tsx"} dark={true} /></div>`}};const c={title:"clients/ui/button/Button",tags:["stories-mdx"],includeStories:["basicButton","color","hue","size","buttonWithIconAndLabel","fullWidth","shadowSize","compact","enabledDisabledButton","rippleEffect"]};c.parameters=c.parameters||{};c.parameters.docs={...c.parameters.docs||{},page:N};const P=["basicButton","color","hue","size","buttonWithIconAndLabel","fullWidth","shadowSize","compact","enabledDisabledButton","rippleEffect"];export{P as __namedExportsOrder,s as basicButton,b as buttonWithIconAndLabel,B as color,v as compact,c as default,z as enabledDisabledButton,f as fullWidth,p as hue,w as rippleEffect,g as shadowSize,m as size};
